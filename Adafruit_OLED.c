...
*/
    ...
    GPIOPinWrite(GPIOA3_BASE, 0x80, 0); //set DC to low
    GPIOPinWrite(GPIOA0_BASE, 0x80, 0); //set OC to low

    MAP_SPICSEnable(GSPI_BASE); //Enable the SPI chip select

    MAP_SPIDataPut(GSPI_BASE, c); //Put the data

    MAP_SPIDataGet(GSPI_BASE, &dummy); //Clear buffer

    MAP_SPICSDisable(GSPI_BASE); //Disable SPI Chip Select

    GPIOPinWrite(GPIOA0_BASE, 0x80, 0); //set OC to high
...
*/
    ...
    GPIOPinWrite(GPIOA3_BASE, 0x80, 0x80); //set DC to high
    GPIOPinWrite(GPIOA0_BASE, 0x80, 0); //set OC to low
